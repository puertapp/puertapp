...
/// Pantalla de inicio que gestiona el login y carga la app
...
class _AppEntryState extends State<AppEntry> {
  ...
  Widget build(BuildContext context) {
    return isAuthenticated
        ? const Main() // <-- Ahora sí existe esta clase abajo
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final String _correctPassword = "estiba"; // Cambia esta contraseña si lo deseas
...
// 👇 Aquí incluye tu clase Main sin modificar (pantalla principal)
...
class _MainState extends State<Main> {
  ...
  // Aquí debes incluir tus listas _portainerList y _polivalenteList tal como las tenías
  ...
  List<int> get _activeList => _isPortainerSelected ? _portainerList : _polivalenteList;
